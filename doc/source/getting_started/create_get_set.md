...
The namespace [AasCore.Aas3_1](../api/AasCore.Aas3_1.yml) contains all the classes of the meta-model.

You can simply use their constructors to create an AAS model.

Usually you start bottom-up, all the way up to the [AasCore.Aas3_1.Environment](../api/AasCore.Aas3_1.Environment.yml).

## Getters and Setters

For each property in the meta-model, there is a corresponding getter and setter.

For example, see the getter and setter for [AasCore.Aas3_1.Submodel.Category].

[AasCore.Aas3_1.Submodel.Category]: ../api/AasCore.Aas3_1.Submodel.yml#AasCore_Aas3_1_Submodel_Category
...
For example, see [AasCore.Aas3_1.Submodel.KindOrDefault].

[AasCore.Aas3_1.Submodel.KindOrDefault]: ../api/AasCore.Aas3_1.Submodel.yml#AasCore_Aas3_1_Submodel_KindOrDefault
...
(We will alias the namespace `AasCore.Aas3_1` to `Aas` for readability.
